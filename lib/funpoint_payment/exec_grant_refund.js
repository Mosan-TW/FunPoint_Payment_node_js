...
class FunPointExecRefundAndGrant{
    constructor(options){
    ...
    _act_base_proc(params){
        if (params.constructor === Object){
            ...
            throw new FunPointError.FunPointInvalidParam(`Received parameter object must be a Object.`);
        }
    }
...
module.exports = FunPointExecRefundAndGrant;